...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans">
     ...
     {/* HERO SECTION */}
      <section className="relative bg-slate-100 text-slate-900 overflow-hidden pt-6 pb-14">
        ...
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#0B2340] via-[#0B2340]/85 to-[#0B2340]/20" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0B2340] via-transparent to-transparent opacity-60" />
          <div className="absolute -top-24 -right-24 w-[350px] h-[350px] rounded-full bg-orange-500/20 blur-3xl glow-anim" />
        </div>

        <div className="relative z-10 max-w-7xl mx-auto px-8 py-10 md:py-16 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          {/* Left Content — Reducido de tamaño */}
          <div className="lg:col-span-8">
            ...
            <h1 className="hero-anim text-3xl md:text-5xl font-extrabold tracking-tight leading-[1.1] mb-4 text-white max-w-2xl" style={{ animationDelay: '0.15s' }}>
              Soluciones solares integrales para hogares y empresas
            </h1>

            <p className="hero-anim text-base md:text-lg text-slate-300 mb-7 leading-relaxed max-w-lg font-light" style={{ animationDelay: '0.3s' }}>
              Transformamos la luz del sol en energía que impulsa tu vida, con los más altos estándares de ingeniería y autonomía.
            </p>

            <div className="hero-anim flex flex-col sm:flex-row gap-3.5" style={{ animationDelay: '0.45s' }}>
              <a 
                href="#tienda"
                className="bg-orange-600 hover:bg-orange-500 active:scale-[0.98] text-white px-6 py-3 rounded-lg font-semibold text-sm transition-all duration-200 shadow-md shadow-orange-950/40 hover:shadow-orange-900/50 hover:-translate-y-0.5 flex items-center justify-center gap-2 group text-center"
              >
              ...
              <a 
                href="#servicios"
                className="border border-white/30 hover:bg-white/10 hover:border-white/50 active:scale-[0.98] text-white px-6 py-3 rounded-lg font-semibold text-sm transition-all duration-200 flex items-center justify-center gap-2 text-center"
              >
        ...
        {/* Feature Badges Grid (Floating at bottom) */}
        <div className="relative z-10 max-w-7xl mx-auto px-8 mt-4">
          <div className="hero-anim bg-white rounded-2xl shadow-xl p-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5" style={{ animationDelay: '0.75s' }}>
            <div className="flex items-center gap-3.5">
              <div className="w-10 h-10 rounded-xl bg-orange-50 flex items-center justify-center text-orange-600 flex-shrink-0">
                <Leaf className="w-4 h-4" />
              </div>
              <div>
                <h4 className="font-semibold text-[#0F172A] text-xs">Energía limpia</h4>
                <p className="text-[11px] text-slate-500">Cuida el planeta</p>
              </div>
            </div>
            <div className="flex items-center gap-3.5 sm:pl-5 sm:border-l border-slate-200">
              <div className="w-10 h-10 rounded-xl bg-orange-50 flex items-center justify-center text-orange-600 flex-shrink-0">
                <TrendingUp className="w-4 h-4" />
              </div>
              <div>
                <h4 className="font-semibold text-[#0F172A] text-xs">Ahorro real</h4>
                <p className="text-[11px] text-slate-500">Reduce tus costos</p>
              </div>
            </div>
            <div className="flex items-center gap-3.5 lg:pl-5 lg:border-l border-slate-200">
              <div className="w-10 h-10 rounded-xl bg-orange-50 flex items-center justify-center text-orange-600 flex-shrink-0">
                <HomeIcon className="w-4 h-4" />
              </div>
              <div>
                <h4 className="font-semibold text-[#0F172A] text-xs">Soluciones a medida</h4>
                <p className="text-[11px] text-slate-500">Hogares y empresas</p>
              </div>
            </div>
            <div className="flex items-center gap-3.5 sm:pl-5 sm:border-l border-slate-200">
              <div className="w-10 h-10 rounded-xl bg-orange-50 flex items-center justify-center text-orange-600 flex-shrink-0">
              ...
              <div>
                <h4 className="font-semibold text-[#0F172A] text-xs">Asesoría experta</h4>
                <p className="text-[11px] text-slate-500">En todo el proceso</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="acerca" className="py-20 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          <ScrollReveal as="slide-right">
            ...
            <div className="flex gap-10 pt-6 border-t border-slate-200">
              <div>
                ...
                <div className="text-xs text-slate-500">Proyectos instalados</div>
              </div>
              <div className="pl-10 border-l border-slate-200">
                <div className="text-3xl font-extrabold text-[#0F172A] mb-1">
                  <AnimatedCounter value={25} suffix=" años" />
                </div>
                <div className="text-xs text-slate-500">Garantía en paneles</div>
              </div>
            </div>
          </ScrollReveal>
          <ScrollReveal as="scale" delay={150}>
            <div className="relative h-96 rounded-2xl overflow-hidden shadow-lg bg-slate-100">
              <Image 
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            <ScrollReveal as="scale" delay={0}>
              <div className="relative bg-white rounded-2xl border border-slate-200 p-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-orange-200">
                <div className="w-14 h-14 rounded-full bg-[#0F172A] text-white flex items-center justify-center font-bold text-lg mb-6 relative z-10">01</div>
            ...
            <ScrollReveal as="scale" delay={120}>
              <div className="relative bg-white rounded-2xl border border-slate-200 p-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-orange-200">
                <div className="w-14 h-14 rounded-full bg-[#0F172A] text-white flex items-center justify-center font-bold text-lg mb-6 relative z-10">02</div>
            ...
            <ScrollReveal as="scale" delay={240}>
              <div className="relative bg-white rounded-2xl border border-slate-200 p-8 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-orange-200">
                <div className="w-14 h-14 rounded-full bg-[#0F172A] text-white flex items-center justify-center font-bold text-lg mb-6 relative z-10">03</div>
      ...
      <section id="tienda" className="max-w-7xl mx-auto px-8 py-20">
        <ScrollReveal className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
          <div>
          ...
          <Link href="/tienda" className="text-sm font-semibold text-[#0F172A] hover:text-orange-600 transition-colors mt-4 md:mt-0 flex items-center gap-2 group">
            Ver otros productos
            <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
          </Link>
        </ScrollReveal>
                ...
                <div className="bg-white rounded-xl border border-slate-200 overflow-hidden hover:shadow-xl hover:border-slate-300 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between group h-full">
                  <div>
                    <div className="relative aspect-square w-full bg-slate-50 overflow-hidden">
                      ...
                      />
                      <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm text-[#0F172A] text-[11px] font-semibold px-3 py-1 rounded-full">
      ...
      <section id="servicios" className="bg-white py-20 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-slate-200 rounded-2xl overflow-hidden">
            <ScrollReveal delay={0}>
              <div className="p-8 bg-white h-full transition-colors duration-300 hover:bg-orange-50/40">
                <Globe2 className="w-6 h-6 text-orange-600 mb-5" strokeWidth={1.75} />
            ...
            <ScrollReveal delay={90}>
              <div className="p-8 bg-white h-full transition-colors duration-300 hover:bg-orange-50/40">
                <Star className="w-6 h-6 text-orange-600 mb-5" strokeWidth={1.75} />
            ...
            <ScrollReveal delay={180}>
              <div className="p-8 bg-white h-full transition-colors duration-300 hover:bg-orange-50/40">
                <Tag className="w-6 h-6 text-orange-600 mb-5" strokeWidth={1.75} />
            ...
            <ScrollReveal delay={270}>
              <div className="p-8 bg-white h-full transition-colors duration-300 hover:bg-orange-50/40">
                <Lock className="w-6 h-6 text-orange-600 mb-5" strokeWidth={1.75} />
          ...
          <ScrollReveal className="flex flex-wrap items-center justify-center gap-x-12 gap-y-6 mt-14 pt-14 border-t border-slate-200">
      ...
      <section className="bg-[#0B2340] text-white py-20 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-8">
          <ScrollReveal className="max-w-2xl mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <ScrollReveal as="slide-right">
              <blockquote className="bg-white/5 p-8 rounded-2xl border border-white/10 flex flex-col justify-between h-full transition-colors duration-300 hover:bg-white/[0.08]">
                ...
                <div className="flex items-center justify-between border-t border-white/10 pt-4">
                  ...
                  <span className="text-blue-300 text-xs font-medium bg-blue-500/10 px-3 py-1.5 rounded-full flex items-center gap-1.5">
          ...
          <ScrollReveal as="scale">
            <div className="bg-white/5 p-8 rounded-2xl border border-white/10 text-center max-w-xl mx-auto">
              ...
              <div className="flex justify-center gap-4 flex-wrap">
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-purple-600 via-pink-600 to-amber-500 text-white px-6 py-3 rounded-lg font-semibold text-sm hover:opacity-90 hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-2">
                ...
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="bg-blue-600 hover:bg-blue-500 hover:-translate-y-0.5 text-white px-6 py-3 rounded-lg font-semibold text-sm transition-all duration-200 flex items-center gap-2">
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                  Facebook
      ...
      <section className="relative bg-orange-600 py-16 overflow-hidden">
        ...
        <ScrollReveal as="scale" className="relative max-w-4xl mx-auto px-8 text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-4">
            ¿Listo para reducir tu cuenta de luz?
          </h2>
          <p className="text-orange-50 mb-8 max-w-xl mx-auto">
            Solicita una cotización sin costo y te asesoramos según tu consumo, tu techo y tu presupuesto.
          </p>
          <a
            href="#contacto"
            className="relative inline-flex items-center gap-2.5 bg-white text-orange-600 px-8 py-4 rounded-lg font-semibold hover:bg-orange-50 hover:-translate-y-0.5 transition-all duration-200 group"
          >
      ...
      <section id="contacto" className="py-20 bg-slate-50">
        <div className="max-w-4xl mx-auto px-8">
          <ScrollReveal as="fade-up" className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-200">
